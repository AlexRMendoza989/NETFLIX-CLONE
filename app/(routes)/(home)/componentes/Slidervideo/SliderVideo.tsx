        ...
        <div className="pt-24 md:pt-0">
          ...
          <p className="max-w-md mt-2 text-xs md:text-base">
            Aprende a crear desde cero un clon de Netflix con todas sus
             funciones clave, desde la gestión de usuarios hasta la 
             reproducción de videos, mientras descubres los secretos detrás 
             de una plataforma de streaming exitosa.
          </p>
